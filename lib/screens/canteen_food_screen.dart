...
class CanteenFoodScreen extends StatefulWidget {
  const CanteenFoodScreen({Key? key}) : super(key: key);

  @override
  State<CanteenFoodScreen> createState() => _CanteenFoodScreenState();
}

class _CanteenFoodScreenState extends State<CanteenFoodScreen> {
  @override
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        CustomButton2(text: 'Change', onPressed: (){}),
                      ],
                    ),
                  ],
                ),
